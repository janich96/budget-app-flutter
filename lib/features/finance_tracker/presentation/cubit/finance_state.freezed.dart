...
mixin _$FinanceState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is FinanceState);
  }
...
extension FinanceStatePatterns on FinanceState {
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(
            ...
            List<AccumulationCategory> accumulationCategories,
    ...
    switch (_that) {
      ...
      case _Loading() when loading != null:
        return loading();
      case _Loaded() when loaded != null:
        return loaded(_that.expenseCategories, _that.accumulationCategories,
            _that.weekEntries);
      case _Error() when error != null:
...
class _Initial implements FinanceState {
  const _Initial();
...
class _Loading implements FinanceState {
  const _Loading();
...
class _Loaded implements FinanceState {
  const _Loaded(
      ...
      : _expenseCategories = expenseCategories,
        _accumulationCategories = accumulationCategories,
  ...
  final List<AccumulationCategory> _accumulationCategories;
  List<AccumulationCategory> get accumulationCategories {
    if (_accumulationCategories is EqualUnmodifiableListView)
      return _accumulationCategories;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_accumulationCategories);
  }

  final List<WeekEntry> _weekEntries;
  List<WeekEntry> get weekEntries {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(
                other._accumulationCategories, _accumulationCategories) &&
            const DeepCollectionEquality()
                .equals(other._weekEntries, _weekEntries));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_accumulationCategories),
      const DeepCollectionEquality().hash(_weekEntries));

  @override
  String toString() {
    return 'FinanceState.loaded(expenseCategories: $expenseCategories, accumulationCategories: $accumulationCategories, weekEntries: $weekEntries)';
  }
}
...
class __$LoadedCopyWithImpl<$Res> implements _$LoadedCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object? accumulationCategories = null,
    ...
    return _then(_Loaded(
      ...
      accumulationCategories: null == accumulationCategories
          ? _self._accumulationCategories
          : accumulationCategories // ignore: cast_nullable_to_non_nullable
              as List<AccumulationCategory>,
      weekEntries: null == weekEntries
          ? _self._weekEntries
...
class _Error implements FinanceState {
  ...
  @override
  String toString() {
    return 'FinanceState.error(message: $message)';
  }
}
